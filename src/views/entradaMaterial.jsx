...
//almacenar fecha
  ...
  return(
    <View style={styles.container}>
        <Text style={styles.textoBien} >Registrar Entrega de Material</Text>
        <Text style={styles.textoSecundario}>Ingrese los datos del nuevo material</Text>
        <Text style={styles.textoSecundario}>Detalles de la entrega</Text>
        ...
        <TextInput style={styles.txtInput} 
                value={Nombres}
                placeholder="Ingresar nombre del trabajador"
                onChangeText={text => setNombres(text)}
                />
        <TextInput style={styles.txtInput} 
                value={Apellidos}
                placeholder="Total Calculado(ex:0.25)"
